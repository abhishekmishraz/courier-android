 ...
 *
 * This class implements the [GojekMqttPingSender] pinger interface allowing applications to send ping packet to server every keep alive interval.
 *
 * @see GojekMqttPingSender
 */
internal class TimerPingSenderGojek(
